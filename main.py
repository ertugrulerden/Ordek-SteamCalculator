...
img1 = Image.open("duck.png").resize((72, 72), Image.LANCZOS)
img1 = ImageTk.PhotoImage(img1)
ordek = tk.Label(root, image=img1, bg='#2F4F4F')
ordek.place(x=182,y=75)

madduckIMG = Image.open("gunDuck.png").resize((72, 72), Image.LANCZOS)
madduckIMG = ImageTk.PhotoImage(madduckIMG)
